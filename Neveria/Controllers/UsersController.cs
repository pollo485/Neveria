...
namespace Neveria.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            ViewData["TagRole"] = new SelectList(_context.Roles, "TagRole", "TagRole");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("TagUser,TagRole,Name,UserName,Email,Password,CreatedAt,IsActive")] User user)
        {
            ...
            ViewData["TagRole"] = new SelectList(_context.Roles, "TagRole", "TagRole", user.TagRole);
            return View(user);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TagUser,TagRole,Name,UserName,Email,Password,CreatedAt,IsActive")] User user)
        {
            if (id != user.TagUser)
            {
                return NotFound();
